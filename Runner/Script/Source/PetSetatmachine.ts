namespace Runner {
    ...
    export class PetState extends ƒAid.ComponentStateMachine<PETSTATE> {
      ...
      public static get(): ƒAid.StateMachineInstructions<PETSTATE> {
        ...
        setup.setTransition(PETSTATE.IDLE, PETSTATE.RUN,  <ƒ.General>this.transit)
        setup.setTransition(PETSTATE.RUN, PETSTATE.SIT,  <ƒ.General>this.transit)
        setup.setTransition(PETSTATE.SIT, PETSTATE.REST,  <ƒ.General>this.transit)
        setup.setTransition(PETSTATE.REST, PETSTATE.IDLE,  <ƒ.General>this.transit)
      ...
      private static transit(_pet: PetState): void {
        console.log("Transit");
